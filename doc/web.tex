...
\begin{document}
	...
	\begin{lemma}\label{lemma: num field disc in terms of norm}
		\uses{lemma: disc of prim elt basis, lemma: alt definition of norm and trace }
	...
	\begin{lemma}\label{lemma: disc int basis}
		\uses{lemma: disc change of basis, lemma: int basis int disc }
	...
	\begin{lemma}\label{lemma: eis crit and alg ints}
		\uses{lemma: norm trace of alg int is int }
	...
	\begin{theorem}\label{theorem: ring of ints of cyclo}
		\uses{lemma: num field disc in terms of norm, lemma: disc int basis, lemma: eis crit and alg ints }
	...
	\begin{theorem}\label{theorem:FLT facts}
		\uses{lemma: unit lemma, lemma: fac of p in p_th root, lemma: ideals mult to power, theorem: ring of ints of cyclo field}
