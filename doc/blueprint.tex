...
\begin{document}
	...
	\begin{lem}\label{lem: num field disc in terms of norm}
		\uses{lem: disc of prim elt basis, lem: alt defn of norm and trace }
	...
	\begin{lem}\label{lem: disc int basis}
		\uses{lem: disc change of basis, lem: int basis int disc }
	...
	\begin{lem}\label{lem: eis crit and alg ints}
		\uses{lem: norm trace of alg int is int }
	...
	\begin{thm}\label{thm: ring of ints of cyclo}
		\uses{lem: num field disc in terms of norm, lem: disc int basis, lem: eis crit and alg ints }
	...
	\begin{thm}\label{thm:FLT facts}
		\uses{lem: unit lem, lem: fac of p in p_th root, lem: ideals mult to power}
